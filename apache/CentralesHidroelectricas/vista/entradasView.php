<div class="col d-flex flex-column justify-content-start align-items-center">              
    ...
    <form class="mt-3 pe-3" action="<?php echo $this->url("entradas", "generaexcell"); ?>" method="POST" id="formdoc">    
    ...
    <form class="mt-3" action="<?php echo $this->url("entradas", "generapdf"); ?>" method="POST" id="formdoc">    
